...
#Files
USER_LIST_FILE = 'hbk_final_users.csv'


# Other params
TIMEZONE = 'America/Los_Angeles'
#MAX_INTERACTION_DIST = 25		# in meters
MAX_INTERACTION_DIST = 100		# in meters
#MAX_INTERACTION_TIME = 900	# in seconds
MAX_INTERACTION_TIME = 3600	# in seconds
